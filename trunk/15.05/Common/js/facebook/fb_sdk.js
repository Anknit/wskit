/*1434004369,,JIT Construction: v1780108,en_US*/
/**
...
try {
    window.FB || (function(window) {
        ...
        (function() {
            var a = {},
                ...
                h = function(i, j, k, l, m) {
                    if (m) {
                        if (!m.callId) m.callId = m.module + ':' + m.line + ':' + m.column;
                        var n = m.callId;
                        a[n] = (a[n] || 0) + 1;
                    }
                    return k.apply(i, j);
        ...
        __d("JSSDKXDConfig", [], {
            ...
            "XdBundleUrl": "\/connect\/xd_arbiter\/1ldYU13brY_.js?version=41",
            "Flash": {
        ...
        __d("URISchemes", ["createObjectFrom"], function(a, b, c, d, e, f, g) {
            b.__markCompiled && b.__markCompiled();
            var h = g(['fb', 'fb-ama', 'fb-messenger', 'fbcf', 'fbconnect', 'fbmobilehome', 'fbrpc', 'file', 'ftp', 'http', 'https', 'mailto', 'ms-app', 'itms', 'itms-apps', 'itms-services', 'market', 'svn+ssh', 'fbstaging', 'tel', 'sms', 'pebblejs', 'sftp']),
                i = {
        ...
        __d("Flash", ["DOMEventListener", "DOMWrapper", "FlashVersionFix", "QueryString", "UserAgent_DEPRECATED", "copyProperties", "guid", "htmlSpecialChars"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
            ...
            function u(w) {
                if (!p) {
                    if (k.ie() >= 9) g.add(window, 'unload', s);
                    p = true;
                }
                o[w] = w;
            }
            var v = {
                embed: function(w, x, y, z) {
                    var aa = m();
                    w = n(w).replace(/&amp;/g, '&');
                    y = l({
                    ...
                    var ba = [];
                    for (var ca in y)
                        if (y.hasOwnProperty(ca) && y[ca]) ba.push('<param name="' + n(ca) + '" value="' + n(y[ca]) + '">');
                    var da = x.appendChild(q.createElement('span')),
        ...
        __d("sdk.XD", ["sdk.Content", "sdk.Event", "Log", "QueryString", "Queue", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "UrlMap", "JSSDKXDConfig", "XDM", "isFacebookURI", "sdk.createIframe", "sdk.feature", "guid"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
            ...
            function pa(ta, ua) {
                if (ua && ua !== 'native' && !s(new o(ua))) return;
                if (typeof ta == 'string') {
                    if (/^FB_RPC:/.test(ta)) {
        ...
        __d("ApiClient", ["ArgumentError", "Assert", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "sprintf", "sdk.URI", "UrlMap", "ApiClientConfig", "invariant"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
            ...
            function ia(ra, sa, ta, ua) {
                ...
                da++;
                if (w) ta = ES('Object', 'assign', false, {}, w, ta);
                ...
                if (ta.transport) {
                    xa = [ta.transport];
                    delete ta.transport;
                } else xa = ['jsonp', 'cors', 'flash'];
                for (var ya = 0; ya < xa.length; ya++) {
                    var za = wa[xa[ya]],
                        ab = ES('Object', 'assign', false, {}, ta);
                    if (za.execute(ra, sa, ab, ua)) return;
                }
                ua({
                    error: {
                        type: 'no-transport',
            ...
            function ja(ra, sa, ta, ua, va, wa) {
                if (wa && wa.error) pa.inform('request.error', sa, ta, ua, wa, ES('Date', 'now', false) - va);
            ...
            function ka(ra) {
                ...
                if (!/^https?/.test(sa) && sa.charAt(0) !== '/') sa = '/' + sa;
                var ta, ua = {};
                try {
                    ta = new q(sa);
                } catch (va) {
                ...
                var xa = ua['function'];
                if (!xa) m.warn('No callback passed to the ApiClient');
                if (ua.object) ta.addQueryData(k(ua.object));
            ...
            function la() {
                for (var ra = [], sa = 0, ta = arguments.length; sa < ta; sa++) ra.push(arguments[sa]);
                var ua = ka(ra),
                    va = ua.uri,
                    wa = ua.callback,
                    xa = ua.params,
            ...
            function na() {
                ...
                la('/', 'POST', {
                    ...
                    } else ES(sa, 'forEach', true, function(xa) {
                        return xa({
                            error: {
        ...
        __d("sdk.init", ["sdk.Cookie", "sdk.ErrorHandling", "sdk.Event", "Log", "ManagedError", "sdk.PlatformVersioning", "QueryString", "sdk.Runtime", "sdk.URI", "createArrayFromMixed"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
            ...
            function r(s) {
                ...
                if (n.getIsVersioned()) {
                    ...
                    if (!s.version) s.version = new o(location.href).getQueryData().sdk_version;
    ...
    new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1780108","message":"' + e.message + '"}}');
}