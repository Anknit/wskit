			...
			$header = <<<EOH
				...
				<!--[if gte mso 9]><xml>
				 <o:DocumentProperties>
				  <o:LastAuthor>Pulsar Administrator</o:LastAuthor>
				  <o:LastSaved>2009-03-17T07:46:23Z</o:LastSaved>
...
EOH;
		...
		*/
		...
		function writeHeadingLine($heading,$line_arr)
		{
			...
			fwrite($this->fp,"<tr><th class=xl26 colspan=".count($line_arr)."><strong><center>$heading</center></strong></th></tr>");
			fwrite($this->fp,"<tr>");
			foreach($line_arr as $col)
